...
#'
#' @export
run_robustness_time_dependent <- function(param_space_name,
                                          param_set,
                                          replicates = 1000) {
  ...
  ext_pars <- c(param_space$mu_min[param_set],
                  param_space$mu_p[param_set])
  nonoceanic_pars <- c(param_space$x_s[param_set],
  ...
  simulation_pars$area_pars <- area_pars
  simulation_pars$ext_pars <- ext_pars
  simulation_pars$extcutoff <- param_space$extcutoff[param_set]
  simulation_pars$nonoceanic_pars <- nonoceanic_pars
