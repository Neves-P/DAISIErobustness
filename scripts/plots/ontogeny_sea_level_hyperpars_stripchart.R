...
oceanic_ontogeny_ed95 <- rbind(
  compile_ed95s("oceanic_ontogeny_cs"),
  compile_ed95s("oceanic_ontogeny_di"),
  compile_ed95s("oceanic_ontogeny_iw")
)
oceanic_sea_level_ed95 <- rbind(
  compile_ed95s("oceanic_sea_level_cs"),
  compile_ed95s("oceanic_sea_level_di"),
  compile_ed95s("oceanic_sea_level_iw")
)
oceanic_ontogeny_sea_level_ed95 <- rbind(
  compile_ed95s("oceanic_ontogeny_sea_level_cs"),
  compile_ed95s("oceanic_ontogeny_sea_level_di"),
  compile_ed95s("oceanic_ontogeny_sea_level_iw")
)
