...
mu <- c(0.4,0.6)    ###mean_mu = 0.8
K <- c(40,Inf)
gam <- c(0.01,0.015)  ###mean_gam = 0.02
laa <- c(0.2,0.4)   ###mean_laa = 0.5
trans <- 0.5
trans2 <- 0.5
trait_low_rates <- expand.grid(time = time,
                               M = M,
                               M2 = M2,
                               lac = lac,
                               mu = mu,
                               ...
                               trans2 = trans2,
                               K = K)
trait_low_rates <- cbind(trait_low_rates,
...
mu <- c(0.6,1.0)    ###mean_mu = 1.2
K <- c(40,Inf)
gam <- c(0.01,0.03)  ###mean_gam = 0.04
laa <- c(0.5,0.8)   ###mean_laa = 1
trans <- 0.5
trans2 <- 0.5
trait_high_rates <- expand.grid(time = time,
                                     M = M,
                                     M2 = M2,
                                     lac = lac,
                                     mu = mu,
                                     ...
                                     trans2 = trans2,
                                     K = K)
trait_high_rates <- cbind(trait_high_rates,
...
trans <- 0.5
trans2 <- 0.5
trait_lac <- expand.grid(time = time,
                              M = M,
                              M2 = M2,
                              lac = lac,
                              mu = mu,
...
trans <- 0.5
trans2 <- 0.5
trait_mu <- expand.grid(time = time,
                         M = M,
                         M2 = M2,
                         lac = lac,
                         mu = mu,
...
trans <- 0.5
trans2 <- 0.5
trait_gamma <- expand.grid(time = time,
                         M = M,
                         M2 = M2,
                         lac = lac,
                         mu = mu,
...
trans <- 0.5
trans2 <- 0.5
trait_laa <- expand.grid(time = time,
                         M = M,
                         M2 = M2,
                         lac = lac,
                         mu = mu,
...
trans <- 0.5
trans2 <- 0.5
trait_lac_mu <- expand.grid(time = time,
                         M = M,
                         M2 = M2,
                         lac = lac,
                         mu = mu,
                         ...
                         trans2 = trans2,
                         K = K)
trait_lac_mu <- cbind(trait_lac_mu,
...
trans <- 0.5
trans2 <- 0.5
trait_lac_gamma <- expand.grid(time = time,
                            M = M,
                            M2 = M2,
                            lac = lac,
                            mu = mu,
                            ...
                            trans2 = trans2,
                            K = K)
trait_lac_gamma <- cbind(trait_lac_gamma,
...
trans <- 0.5
trans2 <- 0.5
trait_lac_laa <- expand.grid(time = time,
                               M = M,
                               M2 = M2,
                               lac = lac,
                               mu = mu,
                               ...
                               trans2 = trans2,
                               K = K)
trait_lac_laa <- cbind(trait_lac_laa,
...
trans <- 0
trans2 <- 0
trait_high_rates_notrans <- expand.grid(time = time,
                                M = M,
                                M2 = M2,
                                lac = lac,
                                mu = mu,
                                ...
                                trans2 = trans2,
                                K = K)
trait_high_rates_notrans <- cbind(trait_high_rates_notrans,
...
trans <- 0.5
trans2 <- 2
trait_high_rates_trans <- expand.grid(time = time,
                                        M = M,
                                        M2 = M2,
                                        lac = lac,
                                        mu = mu,
                                        ...
                                        trans2 = trans2,
                                        K = K)
trait_high_rates_trans <- cbind(trait_high_rates_trans,
