...
mu <- c(0.075, 0.1)    ###mean_mu = 0.1
K <- c(20, Inf)
gam <- c(0.006, 0.008)  ###mean_gam = 0.008
laa <- c(0.075, 0.1)   ###mean_laa = 0.1
trans <- c(0.02, 0.2)
trans2 <- c(0.02, 0.2)
...
mu <- c(0.15, 0.2)    ###mean_mu = 0.2
K <- c(20, Inf)
gam <- c(0.009, 0.012)  ###mean_gam = 0.012
laa <- c(0.15, 0.2)   ###mean_laa = 0.2
trans <- c(0.02, 0.2)
trans2 <- c(0.02, 0.2)
...
##  Keep the same mean value and increase the difference
#
time <- 5
M <- 500
M2 <- 500
lac <- c(0.1, 0.2, 0.4)   ###mean_lac = 0.4
mu <- c(0.05, 0.15, 0.2)    ###mean_mu = 0.2
K <- c(20, Inf)
gam <- c(0.002, 0.006, 0.008)  ###mean_gam = 0.008
laa <- c(0.05, 0.15, 0.2)   ###mean_laa = 0.2
trans <- c(0.02, 0.2)
trans2 <- c(0.02, 0.2)
trait_large_diff <- expand.grid(
  time = time,
  M = M,
  M2 = M2,
  lac = lac,
  ...
  trans2 = trans2,
  K = K)
trait_large_diff <- cbind(
  trait_large_diff,
  lac2 = 0.8 - trait_large_diff[, 4] ,
  mu2 = 0.4 - trait_large_diff[, 5] ,
  gam2 = 0.016 - trait_large_diff[, 6],
  laa2 = 0.4 - trait_large_diff[, 7])
