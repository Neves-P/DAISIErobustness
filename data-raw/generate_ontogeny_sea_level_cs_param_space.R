...
# Complete oceanic ontogeny sea-level clade-specific diversity-depencent
# parameter set

oceanic_ontogeny_sea_level_cs <- rbind(
  oceanic_ontogeny_sea_level_young,
  oceanic_ontogeny_sea_level_old
)

save(oceanic_ontogeny_sea_level_cs,
     file = "inst/extdata/oceanic_ontogeny_sea_level_cs.rda")
