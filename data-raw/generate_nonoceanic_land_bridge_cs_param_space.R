# Nonoceanic land-bridge clade-specific diversity-dependent
## Young
...
# Complete nonoceanic land-bridge clade-specific diversity-dependent parameter
# set

nonoceanic_land_bridge_cs <- rbind(
  young_lb_dd,
  old_lb_dd
)

usethis::use_data(nonoceanic_land_bridge_cs, overwrite = TRUE)
