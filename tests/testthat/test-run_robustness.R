...
test_that("run pipeline = novel_sim", {
  if (Sys.getenv("TRAVIS") != "" && Sys.info()[[1]] != "Darwin"
    ...
    expect_length(robustness_output[[1]][[1]], 15)
    expect_equal(robustness_output[[1]][[1]][[1]]$island_age, 6.15)
    expect_equal(robustness_output[[1]][[1]][[1]]$not_present, 986)
    expect_equal(nrow(robustness_output[[1]][[1]][[1]]$stt_all), 325)
    ...
    expect_length(robustness_output[[2]][[1]], 9)
    expect_equal(robustness_output[[2]][[1]][[1]]$island_age, 6.15)
    expect_equal(robustness_output[[2]][[1]][[1]]$not_present, 992)
    expect_equal(nrow(robustness_output[[2]][[1]][[1]]$stt_all), 348)
