...
test_that("test calc_ml output is correct with traits sim", {
  ...
  expect_length(novel_ml, 8)
  expect_equal(novel_ml$lambda_c, 0.17488831874926078)
  expect_equal(novel_ml$mu, 0.071370181965553031)
  expect_equal(novel_ml$K, 109123.1776152138)
  expect_equal(novel_ml$gamma, 0.00756456636864789)
  expect_equal(novel_ml$lambda_a, 0.091357671063154774)
  expect_equal(novel_ml$loglik, -252.83349534415478)
  expect_equal(novel_ml$df, 5)
  expect_equal(novel_ml$conv, 0)
})
