...
test_that("test calc_ml output is correct with traits sim", {
  ...
  expect_equal(novel_ml$mu, 0.98595075294401635)
  expect_equal(novel_ml$K, 5.0752756953749492)
  expect_equal(novel_ml$gamma, 0.023442697933727469)
  expect_equal(novel_ml$lambda_a, 0.12049592404810311)
  expect_equal(novel_ml$loglik, -176.05610566953322)
  expect_equal(novel_ml$df, 5)
  expect_equal(novel_ml$conv, 0)
})
