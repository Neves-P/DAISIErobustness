...
test_that("test calc_ml output is correct with traits sim", {
  ...
  expect_length(novel_ml, 8)
  expect_equal(novel_ml$lambda_c, 0.26145228521236752)
  expect_equal(novel_ml$mu, 0.62933985820412774)
  expect_equal(novel_ml$K, 211158.48698200379)
  expect_equal(novel_ml$gamma, 0.011012655882763293)
  expect_equal(novel_ml$lambda_a, 0.87811882222480142)
  expect_equal(novel_ml$loglik, -104.98946394324359)
  expect_equal(novel_ml$df, 5)
  expect_equal(novel_ml$conv, 0)
})
